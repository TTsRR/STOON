...
function DevBot(msg) 
local hash = database:sismember(bot_id.."STOON:Sudo:User", msg.sender_user_id_) 
if hash or DevSTOON(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevSTOON(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."STOON:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevSTOON(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."STOON:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevSTOON(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."STOON:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevSTOON(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."STOON:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevSTOON(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."STOON:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."STOON:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."STOON:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."STOON:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."STOON:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."STOON:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
var = "البوت"
elseif database:sismember(bot_id.."STOON:Sudo:User", user_id) then
var = database:get(bot_id.."STOON:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."STOON:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."STOON:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."STOON:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."STOON:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."STOON:Manager"..chat_id, user_id) then
var = database:get(bot_id.."STOON:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."STOON:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."STOON:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."STOON:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."STOON:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."STOON:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."STOON:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."STOON:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."STOON:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."STOON:GBan:User",User_id) then
Var = true
else
Var = false
end
...
database:sadd(bot_id..'STOON:Chek:Groups',idg) 
database:set(bot_id.."STOON:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'STOON:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."STOON:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."STOON:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."STOON:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."STOON:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."STOON:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
function STOON_Files(msg)
for v in io.popen('ls STOON_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("STOON_Files/"..v)
if plugin.STOON and msg then
pre_msg = plugin.STOON(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function STOON_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'STOON:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'STOON:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."STOON:STOON:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."STOON:STOON:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."STOON:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'STOON:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'STOON:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'STOON:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'STOON:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."STOON:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."STOON:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."STOON:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."STOON:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."STOON:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."STOON:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."STOON:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."STOON:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."STOON:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."STOON:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."STOON:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."STOON:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."STOON:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."STOON:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."STOON:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."STOON:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."STOON:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."STOON:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."STOON:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."STOON:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."STOON:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."STOON:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."STOON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء وضع الوصف") 
database:del(bot_id.."STOON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."STOON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."STOON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء حفظ الترحيب") 
database:del(bot_id.."STOON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."STOON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."STOON:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"📮┇تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."STOON:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"📥┇تم الغاء حفظ الرابط")       
database:del(bot_id.."STOON:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."STOON:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."STOON:STOON:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه للخاص") 
database:del(bot_id.."STOON:STOON:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'STOON:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."STOON:STOON:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."STOON:STOON:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."STOON:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."STOON:STOON:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."STOON:STOON:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."STOON:STOON:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."STOON:STOON:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."STOON:UsersBot")   
...
local STOON_Msg = database:get(bot_id.."STOON:Add:Filter:Rp2"..text..msg.chat_id_)   
if STOON_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..STOON_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."STOON:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."STOON:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."STOON:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."STOON:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "📥┇ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."STOON:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."STOON:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇ارسل الامر الجديد")  
database:del(bot_id.."STOON:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."STOON:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."STOON:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."STOON:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."STOON:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."STOON:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇تم حفظ الامر")  
database:del(bot_id.."STOON:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."STOON:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."STOON:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."STOON:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."STOON:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."STOON:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."STOON:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."STOON:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."STOON:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."STOON:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'STOON:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."STOON:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."STOON:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."STOON:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."STOON:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."STOON:lockpin"..msg.chat_id_)  
database:srem(bot_id.."STOON:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."STOON:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."STOON:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'STOON:'..lock..msg.chat_id_)    
end
...
if text == ("المطورين") and DevSTOON(msg) then
local list = database:smembers(bot_id.."STOON:Sudo:User")
t = "\n⛔┇قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."STOON:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."STOON:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."STOON:Manager"..msg.chat_id_)
t = "\n⛔┇قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."STOON:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."STOON:Mod:User"..msg.chat_id_)
t = "\n⛔┇قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."STOON:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."STOON:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."STOON:Muted:User"..msg.chat_id_)
t = "\n⛔┇قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."STOON:User:Name" .. v)
if username then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSTOON(msg) then
...
database:sadd(bot_id.."STOON:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevSTOON(msg) then
...
database:sadd(bot_id.."STOON:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevSTOON(msg) then
...
database:sadd(bot_id.."STOON:GBan:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSTOON(msg) then
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_STOON, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevSTOON(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_STOON(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","💢┇تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."STOON:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevSTOON(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."STOON:GBan:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSTOON(msg) then
function Function_STOON(extra, result, success)
database:sadd(bot_id.."STOON:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_STOON, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevSTOON(msg) then
...
database:sadd(bot_id.."STOON:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevSTOON(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."STOON:Sudo:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevSTOON(msg) then
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_STOON, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevSTOON(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_STOON(extra, result, success)
if result.id_ then
database:srem(bot_id.."STOON:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevSTOON(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."STOON:Sudo:User", userid)
...
function Function_STOON(extra, result, success)
database:sadd(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_STOON(extra, result, success)
if result.id_ then
database:srem(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:sadd(bot_id.."STOON:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Constructor"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_STOON, nil)
end
...
function Function_STOON(extra, result, success)
if result.id_ then
database:srem(bot_id.."STOON:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","💢┇تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."STOON:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","💢┇تم تنزيله من المنشئين")  
end
...
function Function_STOON(extra, result, success)
database:sadd(bot_id.."STOON:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Manager"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_STOON(extra, result, success)
if result.id_ then
database:srem(bot_id.."STOON:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."STOON:Manager"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:sadd(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Mod:User"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_STOON(extra, result, success)
if result.id_ then
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:sadd(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Special:User"..msg.chat_id_, userid)
...
function Function_STOON(extra, result, success)
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_STOON(extra, result, success)
if result.id_ then
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."STOON:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local STOONrt = database:get(bot_id.."STOON:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if STOONrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."STOON:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif STOONrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."STOON:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif STOONrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."STOON:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif STOONrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif STOONrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."STOON:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local STOONrt = database:get(bot_id.."STOON:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if STOONrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."STOON:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif STOONrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."STOON:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif STOONrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n🔰┇تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."STOON:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."STOON:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."STOON:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."STOON:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."STOON:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."STOON:Muted:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."STOON:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."STOON:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."STOON:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"💢┇انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"📫┇ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."STOON:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."STOON:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"📮┇تم وضع زمن التكرار ("..Num..")") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"📥┇ارسل رابط المجموعه او رابط قناة المجموعه")
database:setex(bot_id.."STOON:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
...
if text == "الرابط" then 
local status_Link = database:get(bot_id.."STOON:Link_Group"..msg.chat_id_)
...
database:del(bot_id.."STOON:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."STOON:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."STOON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."STOON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."STOON:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."STOON:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."STOON:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل ترحيب المجموعه") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."STOON:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."STOON:Get:Welcome:Group"..msg.chat_id_) 
...
local list = database:smembers(bot_id.."STOON:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."STOON:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."STOON:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local STOON_Msg = database:get(bot_id.."STOON:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..STOON_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"📫┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."STOON:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."STOON:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."STOON:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."STOON:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."STOON:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Addictive(msg) then    
send(msg.chat_id_, msg.id_,"🔖┇ارسل الكلمه الان")  
database:set(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."STOON:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."STOON:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."STOON:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."STOON:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "📫┇تم الغاء حفظ القوانين") 
database:del(bot_id.."STOON:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."STOON:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."STOON:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."STOON:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."STOON:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
for k,v in pairs(list) do
Cmds = database:get(bot_id.."STOON:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
database:del(bot_id.."STOON:List:Cmd:Group:New"..msg.chat_id_)
end
...
local list = database:smembers(bot_id.."STOON:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."STOON:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."STOON:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."STOON:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."STOON:Coomds"..msg.chat_id_)
end
...
if database:get(bot_id.."STOON:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"☑┇تم الغاء الامر ") 
database:del(bot_id.."STOON:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."STOON:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."STOON:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
for k,v in pairs(list) do
database:del(bot_id.."STOON:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."STOON:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."STOON:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."STOON:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."STOON:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."STOON:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."STOON:Add:Rd:Manager:File"..v..msg.chat_id_)
...
for k,v in pairs(list) do
if database:get(bot_id.."STOON:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق 🃏"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره 🎇"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف 📁"
elseif database:get(bot_id.."STOON:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id.."STOON:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."STOON:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."STOON:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."STOON:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."STOON:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."STOON:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."STOON:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."STOON:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."STOON:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"📫┇ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."STOON:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."STOON:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."STOON:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."STOON:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."STOON:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."STOON:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."STOON:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."STOON:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."STOON:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."STOON:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."STOON:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."STOON:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."STOON:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."STOON:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'STOON:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."STOON:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."STOON:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."STOON:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."STOON:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."STOON:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."STOON:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."STOON:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."STOON:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'STOON:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevSTOON(msg) then 
local list = database:smembers(bot_id.."STOON:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."STOON:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."STOON:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."STOON:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."STOON:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."STOON:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."STOON:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."STOON:Add:Rd:Sudo:File"..v)
database:del(bot_id.."STOON:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."STOON:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"📌┇تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevSTOON(msg) then 
local list = database:smembers(bot_id.."STOON:List:Rd:Sudo")
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."STOON:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif database:get(bot_id.."STOON:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."STOON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."STOON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."STOON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."STOON:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."STOON:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."STOON:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."STOON:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."STOON:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."STOON:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."STOON:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."STOON:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"📌┇تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevSTOON(msg) then 
send(msg.chat_id_, msg.id_,"📥┇ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."STOON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevSTOON(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."STOON:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."STOON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."STOON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."STOON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."STOON:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."STOON:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"📌┇تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'STOON:'..v..text)
end
database:del(bot_id.."STOON:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."STOON:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."STOON:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'STOON:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."STOON:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."STOON:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."STOON:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."STOON:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."STOON:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."STOON:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."STOON:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."STOON:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."STOON:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."STOON:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."STOON:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."STOON:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."STOON:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."STOON:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."STOON:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."STOON:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."STOON:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."STOON:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if not database:get(bot_id.."STOON:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."STOON:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."STOON:Kick:Me"..msg.chat_id_,true)  
Text = "\n📫┇تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_STOON(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."STOON:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."STOON:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."STOON:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_STOON(extra, result, success)
if database:sismember(bot_id.."STOON:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."STOON:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."STOON:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."STOON:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."STOON:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."STOON:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"📫┇ تم مغادرة المجموعه") 
database:srem(bot_id.."STOON:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."STOON:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevSTOON(msg) then   
database:del(bot_id.."STOON:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"📫┇تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevSTOON(msg) then  
database:set(bot_id.."STOON:Left:Bot"..msg.chat_id_,true)   
...
if DevSTOON(msg) then
database:setex(bot_id.."STOON:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."STOON:Status:Bc") and not DevSTOON(msg) then 
send(msg.chat_id_, msg.id_,"📫┇الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."STOON:STOON:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."STOON:STOON:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."STOON:STOON:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."STOON:STOON:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."STOON:STOON:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥┇ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevSTOON(msg) then  
database:del(bot_id.."STOON:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevSTOON(msg) then  
database:set(bot_id.."STOON:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n📫┇تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."STOON:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."STOON:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."STOON:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."STOON:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."STOON:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."STOON:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."STOON:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."STOON:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."STOON:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."STOON:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."STOON:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."STOON:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n🔰┇ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n🔏┇علامة ال {✓} تعني مفعل"..
...
if Owner(msg) then
database:del(bot_id.."STOON:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '📌┇تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."STOON:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء تعين الايدي") 
database:del(bot_id.."STOON:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."STOON:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."STOON:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'📌┇تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'STOON:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'STOON:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."STOON:Spam:Group"..msg.sender_user_id_,text) 
...
local get_id = database:get(bot_id.."STOON:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'STOON:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'STOON:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'STOON:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'STOON:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
...
local edit = database:get(bot_id..'STOON:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text == 'جهاتي' then
local addmem = database:get(bot_id.."STOON:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
if text == "تنظيف المشتركين" and DevSTOON(msg) then
local pv = database:smembers(bot_id..'STOON:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'STOON:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevSTOON(msg) then
local group = database:smembers(bot_id..'STOON:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'STOON:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevSTOON(msg) then  
...
if text == 'تفعيل البوت الخدمي' and DevSTOON(msg) then  
database:del(bot_id..'STOON:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevSTOON(msg) then  
database:set(bot_id..'STOON:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevSTOON(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'STOON:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'👥┇ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'STOON:Chek:Groups')  
local Users = database:scard(bot_id..'STOON:UsersBot')  
send(msg.chat_id_, msg.id_,'🔘┇احصائيات البوت \n\n👥┇عدد المجموعات *~ '..Groups..'\n👤┇عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevSTOON(msg) then
local list = database:smembers(bot_id..'STOON:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'STOON Chat'
ASAS = database:smembers(bot_id.."STOON:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."STOON:Constructor"..v)
MDER = database:smembers(bot_id.."STOON:Manager"..v)
MOD = database:smembers(bot_id.."STOON:Mod:User"..v)
link = database:get(bot_id.."STOON:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"STOON":"'..NAME..'",'
else
t = t..',"'..v..'":{"STOON":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'STOON:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevSTOON(msg) then
t = '☑┇جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls STOON_Files'):lines() do
if v:match(".lua$") then
...
local Check_File_is_Found = io.open("STOON_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevSTOON(msg) then
...
if text == "مسح جميع الملفات" and DevSTOON(msg) then
os.execute("rm -fr STOON_Files/*")
...
database:set(bot_id.."STOON:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'STOON:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
database:sadd(bot_id..'STOON:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'👥┇تم نقل : '..#Groups..' كروب\n👤┇تم نقل : '..#Users..' مشترك \n🔘┇من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevSTOON(msg) then
database:del(bot_id..'STOON:Text_Dev')
...
if text == 'رفع النسخه الاحتياطيه' and DevSTOON(msg) then   
...
if text == "تحديث" and DevSTOON(msg) then
dofile("STOON.lua")  
send(msg.chat_id_, msg.id_, "☑┇تم التحديث")
end
...
🌐┇STOON TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/nayy2019)

📋┇ [STOON Dev](https://t.me/STOONTEAM)

📁┇ [Source  Files](https://t.me/STOON_sudo)

🌐┇ [STOON iNDT](https://t.me/nayy2019/4611)
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'STOON:Num:Add:Bot') or 0) and not DevSTOON(msg) then
send(msg.chat_id_, msg.id_,'👥┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'STOON:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'STOON:Chek:Groups',msg.chat_id_) then
...
Reply_Status(msg,result.id_,'reply_Add','☑┇تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'STOON:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'STOON:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'STOON:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'STOON:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevSTOON(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if DevSTOON(msg) and msg.reply_to_message_id_ ~= 0  then    
...
database:srem(bot_id..'STOON:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
if text and not database:sismember(bot_id..'STOON:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'STOON:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'STOON:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."STOON:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."STOON:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."STOON:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."STOON:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."STOON:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."STOON:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."STOON:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."STOON:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."STOON:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
if database:get(bot_id.."STOON:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."STOON:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."STOON:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."STOON:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local STOON_Msg = database:get(bot_id.."STOON:Add:Filter:Rp2"..text..result.chat_id_)   
if STOON_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..STOON_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'STOON:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'STOON:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'STOON:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'STOON:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'STOON:Chek:Groups',v)  
end
...
database:sadd(bot_id..'STOON:Chek:Groups',v)  
end end,nil)
