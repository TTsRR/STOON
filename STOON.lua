...
local STOON_Msg = ''  
if msgs < 100 then 
STOON_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
STOON_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
STOON_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
STOON_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
STOON_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
STOON_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
STOON_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
STOON_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
STOON_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
STOON_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
STOON_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
STOON_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
STOON_Msg = 'رب التفاعل '  
end 
return STOON_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSTOON(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..STOONk..''..STOON..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'Ooko0')..')'
...
usertext = '\n✨↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Ooko0')..') ~'
status  = '\n تم ترقيته مطور في البوت'
...
if STOON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Ooko0')..') \n 📬┇'..STOON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/Ooko0)}\n🚫┇["..STOON_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/Ooko0)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Ooko0')..') \n تـم قفـل التاك بالكتم\n⛔┇ الحاله ←الكتم ')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Ooko0')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
'هيا مقد معانا؟ ',
'تطمن موجود',
'لا تذكر اسمي '..Namebot..' اسكت ولا اسمع لك كلمه'
}
...
local texting = {"سَم يقلبي .","عييون البوت ، وقلبـه .","امـر يعييني ."}
...
"شـڳـلڪ فيـها😹؟! ",
" ايـلافيـو 🥺🥀 ",
 "لاقيمه للبشـر امامـڲ🙈🥀 ",
 "خليني احبك🙈♥ ",
" ممـكن خـاص 🙈♥ ",
 "ممـكن ابـلعشـڴ🙊💋 ",
 "لاحـالـي ولا حـاليـهہ☹️😹 ",
" تخـليني😹♥ ",
" ااااه يا حنـان 🙊😂♥ ",
" ور؏😹♥ ",
" ياحلو منين الله مشـعګـم🙈♥ ",
" ممـكن نـرتبـط🙈♥؟! ",
" شـل الله حظك وحظ ابوك😹♥ ",
" مارتاحلك😐🥺 ",
" مـن حـلاتڪ قـررت اتـزوج اخـتڳ😔😂 ",
" ونعـم بـكك🖕 ",
" راح زمـان المـزز الان جو الور؏ـان ",
" مـن ويـن مشـ؏ـت تيـهہ الصـورهہ🤔 ",
" مٌمٌـكِنَ نَـرَتْبّـطِ 🙂♥ ",
" المـزهہ حقـي🤤❤ ",
" صورتك كسرت قلبي☹💔 ",
" اريد اجاملك واقلك حلو بس متردد ☹",
}
...
-- vardump(data) 
STOONdx(msg.chat_id_, msg.id_, '📤┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لا سلام علئ طعام.","وعليكم السلام ورحمة الله وبركاته الي في جيبك جيبة","وعليكم السلام ","علينا وعليك." }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-------------------------------
if text == "كيفك" or text == "كيفكم" or text == "كيف الحال" or text == "كيف انتو" or text == "كيفنت" or text == "كيفنتي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {",بخير بحروفك .","تمام يعييني .","بخيير بشوفة حروفك .","مـا دخـلك؟ "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
---------------------------
if text == "نرتبط" or text == "نتيكن" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لاتحتك","يـالله ","لمـدة كـم؟ ",",مرتبـط لاتحـاول" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----------------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"قمنقـلع","تسوي نفسك تستحي وكأني ما اعرفك؟"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
--------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يوم كباقي الايام لكن المتزوجين خربوا سمعته ","والسناقل ما عندهم ونيس" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-------
if text == "هاي. " or text == "هاي" or text == "هايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ارحـب عزيزي .","اطلق هـاي .","افخم هـاي ." }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-------
if text == "الان هذا بوت" or text == "هذا بوت" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لا سندوتش شوارما,","اي بوت او ما مليت عينك؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
--------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"الاغاني حرام قول اقري قرأن افضل لك,","اخاف تنطرب وتضل ناشب لي😌💔","غني لي شوي شوي غني لي وما اعرف ايش بعدها ","انت دخلت جروب مش ذا فويس؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-------
if text == "باي" or text == "يرحله" or text == "ترحلها" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"فمـانه يعيني .","استودعتك الله . ","انتبهـلك عييني ."}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
--------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ي ليتك م جيت","ويعني؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {" نـورَ الـحاضـريَـنَ يعـينيَ","الـنَورَ نـورَكِ","جزء ضئيل من نورك","مٌـن بعـدكِ." }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"انت دخلت جروب محترم؟","ابوس من ؟","روح غسل وجهك ورجعت ,","اللهم اني صائم","قول هو","تزوجيني ؟","ماابوس حيوانات","اقلع"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"امك انت لا تسب","مالها امك؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"خالتك انت","م بعدك ,","ما تشتي من خالة الولد؟","قل خيرا او اصمت" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"علئ وجهك","عسلل  ,","لا تتفل برجعها لوجهك","فلنبدأ حرب تفال ؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ايش هذي الضحكه البخيله؟","ي ليت كنت ساكت","تضحك وانت حتئ ابتسامه م ابتسمت صح؟","ضحكه بلا سبب قلة بلاغه , تفهم ما تفهم مشكلتك" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"انتبه يطق لك عرق","حتئ وانت عصبي سخيف؟","دايمه","دلا دلا علئ روحك" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "😒" or text == "😒😒" or text == "😒😒😒" or text == "😒😒😒😒" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"م احد معبر لك فلها بس,","اخر همي","اعدل نفسك لا افعل كف ثلاثي الابعاد يعدل ديكور وجهك," }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "🌝" or text == "🌝??" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اشتحط ","من بين ثلاثه الف فيس م اخترت غير هذا؟","ليتك م تكلمت" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "💋" or text == "💋💋" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"قلة ادب","الله يرحمك ي رجاله" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
if text == "💔" or text == "💔💔" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اتفل والصقه لك؟","ولو ما تستاهل ربي يجبره.","من كسرك؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
if text == "😻" or text == "😻😻" or text == "😍😍" or text == "😍" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"شكلك اول مره تشوف ايموجي صح؟","اخبل.","اثقل شوي" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
if text == "😐" or text == "🙂" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ايش قد معانا؟","سخيف؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ضحكة عنزه","حتئ بالضحك بخيل؟⇣ۦ ٰ" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-------
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لا تقول","اكرمنا بسكوتك افضل","ما افهم لغة الحيوانات" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "ايش فيك" or text == "مالك " then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"كل خير","ما عليك." }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "🌚💔" or text == "💔" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"خير يطير؟","الله يكسرك","ربي يجبرك" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "فديتك" or text == "فديتش" or text == "فدوه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"فـداكِ","فـداك كل القـروب","وانَـاا؟ ","مجـارَ مـن الفدا"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end

-----
if text == "خاص" or text == "خاصك" or text == "تعال خاص" or text == "تعالي خاص" or text == "خاصك." or text == "خاصش" or text == "خاصش." or text == "تعالو خاص" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لـنا اللـهه","لُا مـارح اجـيَ","ممٌنَــوع","يـاللـهه" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"فَـيَ الـخاصّ مو هـنا","يَـالبـيَـهه","اسـتحُـيَ" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end

-----
if text == "كلزق" or text == "كلزق." or text == "كل زق" or text == "كل زقق" or text == "كل زق." or text == "كل زقق." or text == "كلخرا" or text == "كلخرا." then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"قلة ادب","مخـليـهه لـكِ","مٌـاكِـلُكِ","شِـلـونَ اكـلكِ؟؟ " }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "😢" or text == "😢😢" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اخشوشنوا","جعل لك عمئ","تأثرت"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
if text == "ميت" or text == "اصنام" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لكن عايش عناد","شيء راجع لنا ايش دخلك؟","اسكت فاعلين استجمام" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "اسكت" or text == "اسكتي" or text == "انطم" or text == "اسكت." or text == "اصه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ابشـرعييني","حـاضررعييـني","اكِ يـعييَنيَ","ابشِـرَيـقلُـبّيَ"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
...
if text and text:match("(.*)(تنظيف)(.*)") then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"تـم تعديل من كلمت تنظيف الـئ مسح ٰ" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-------
if text == "جبر" or text == "جبر" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لقـلبكِ","مبـسمكِ" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "انا." or text == "انا" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اشفيـكِ انـت؟","اي صـحُ ","لُا" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "ضابح" or text == "ضـابحه" or text == "ضايق" or text == "ضايقه" or text == "ضوجه" or text == "ملل" or text == "🚶‍♂💔" or text == "🚶‍♂" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"الُـلـهہ يـرزقًـكِ بسـالفه ","سلامـتك يَعـيني" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
------
if text == "احبك" or text == "تحبني" or text == "تحبني." or text == "احبك." then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = 
{"اهيّـم فيك .","اعششق حروفك .","امـوت فقلبك ." }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == "." or text == ".." then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"»(- ـآيهــآإ ﺂﻟﻣﺸتـآإقـﯗن ﻟنـﯛر جمـآﻟهۂ ﺻلـوآ ﻋليـهۂ وﺳلمـوآ ﺗﺳليمـاً ˝ ٴ › ✨♥️ֆ۽","[-قـروب‌مِكس‌بنـات‌للسـوالف .🖤.](https://t.me/joinchat/AAAAAFBF-eOisxwf5ow71w)" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
----------------------------------------------------------------------------
...
if STOON1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..STOON1_Msg)
