...
sudo_users = {SUDO,746233853,698440689}   
...
{'اذاعه 👥','اذاعه خاص 🗣️'},
{'اذاعه بالتثبيت 📣','معلومات السيرفر 📊'},
